 ...
 * </p>
 */
public class NullStringToLongConverter
        extends AbstractNullStringToNumberConverter<Long> {
     ...
     */
    public NullStringToLongConverter(String errorMessage) {
     ...
     *            the error message to use if conversion fails
     */
    public NullStringToLongConverter(Long emptyValue, String errorMessage) {
