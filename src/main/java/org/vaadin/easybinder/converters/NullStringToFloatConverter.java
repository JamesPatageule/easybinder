 ...
 * </p>
 */
public class NullStringToFloatConverter
        extends AbstractNullStringToNumberConverter<Float> {
     ...
     */
    public NullStringToFloatConverter(String errorMessage) {
     ...
     *            the error message to use if conversion fails
     */
    public NullStringToFloatConverter(Float emptyValue, String errorMessage) {
